...
class ShipmentTests(TestCase):
    ...
    @mock.patch('shipment.views.request_is_limited', return_value=False)
    def test_create_shipment(self, request_limited_mock):
    ...
    @mock.patch('shipment.views.request_is_limited', return_value=False)
    def test_print_waybill(self, request_limited_mock):
    ...
    def test_failed_print_waybill_tracking_not_found(self):
        ...
        self.assertEqual({'error': "Can't find tracking id"}, response.json())
    ...
    def test_tracking_status(self):
        ...
        self.assertEquals(200, response.status_code)
        self.assertEquals({'success': 'Shipping status is SCHEDULED'}, response.json())
    ...
    @mock.patch('shipment.views.request_is_limited', return_value=False)
    def test_cancel_tracking(self, request_limited_mock):
        tracking_id = '5f964902797d45fd9fce17813415468f'
        ShipmentFactory(tracking_id=tracking_id)
        ...
        self.assertEquals(200, response.status_code)
        self.assertEquals({'success': 'Shipping is cancelled'}, response.json())
    ...
    def test_update_status(self):
        ...
        self.assertEquals(200, response.status_code)
        self.assertEquals({'success': 'Shipping is updated'}, response.json())
